...
<!-- start kelas page -->
<section class="kelaspage" id="kelaspage">
    <div class="center-text">
        <h2 style="margin-top: 100px; border: 2px solid #83769c;
    padding: 10px;
    border-radius: 10px;
